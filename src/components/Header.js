...
const Header = () => {
  ...
  return (
    <div className="flex  justify-between  items-center absolute w-full py-2 px-8 bg-gradient-to-b from-black z-10 flex-col md:flex-row">
      <div className="flex flex-col align-center md:align-left md:flex-row items-center">
        <Link to="/browse">
          <img
            className="w-44 cursor-pointer"
            src={NETFLIX_LOGO}
